...
alternatives_influenceFile <- "alternatives_influence.xml"
prominenceFile <- "out_effect.xml"
relationFile <- "in_effect.xml"
...
loadXMCDAv3(xmcdaData, inDirectory, alternatives_influenceFile, mandatory = TRUE, xmcdaMessages, "alternativesMatrix")
