# usage:
# R --slave --vanilla --file=dematelInfluenceCLI_XMCDAv2.R --args "[inDirectory]" "[outDirectory]"
...
results <- handleException(
	function() return(dematelInfluence(inputs)),
	xmcdaMessages,
...
stopIfNull(xResults, "Could not convert dematelInfluence results into XMCDA")
