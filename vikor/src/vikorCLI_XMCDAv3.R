# usage:
# R --slave --vanilla --file=vikorCLI_XMCDAv2.R --args "[inDirectory]" "[outDirectory]"
rm(list=ls())
...
criteria_scalesFile <- "criteria_scales.xml"
...
loadXMCDAv3(xmcdaData, inDirectory, performanceFile, mandatory = TRUE, xmcdaMessages, "performanceTable")
loadXMCDAv3(xmcdaData, inDirectory, weightsFile, mandatory = TRUE, xmcdaMessages, "criteriaValues")
loadXMCDAv3(xmcdaData, inDirectory, criteria_scalesFile, mandatory = TRUE, xmcdaMessages, "criteriaScales")
loadXMCDAv3(xmcdaData, inDirectory, method_parametersFile, mandatory = TRUE, xmcdaMessages, "programParameters")
...
results <- handleException(
  function() vikor(inputs$performanceTable, inputs$weights, inputs$criteriaTypes, inputs$v),
  xmcdaMessages,
