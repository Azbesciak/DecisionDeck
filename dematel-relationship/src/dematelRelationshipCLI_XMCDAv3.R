# usage:
# R --slave --vanilla --file=dematelInfluenceCLI_XMCDAv3.R --args "[inDirectory]" "[outDirectory]"
rm(list=ls())
...
dir.create(file.path(outDirectory), showWarnings = FALSE, recursive = TRUE)
...
loadXMCDAv3(xmcdaData, inDirectory, "alternatives.xml", mandatory = TRUE, xmcdaMessages, "alternatives")
loadXMCDAv3(xmcdaData, inDirectory, "out_effect.xml", mandatory = TRUE, xmcdaMessages, "alternativesValues")
loadXMCDAv3(xmcdaData, inDirectory, "in_effect.xml", mandatory = TRUE, xmcdaMessages, "alternativesValues")
loadXMCDAv3(xmcdaData, inDirectory, "total_influence.xml", mandatory = TRUE, xmcdaMessages, "alternativesMatrix")
loadXMCDAv3(xmcdaData, inDirectory, "alpha.xml", mandatory = FALSE, xmcdaMessages, "programParameters")
